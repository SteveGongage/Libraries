...
<body>
	...
	<cfoutput>
		...
		<form name="formTable" action="" method="get">
			<input type="hidden" name="DSN" value="#DSN#">

			<select name="TableName" onchange="formTable.submit()">
				<option value="">Choose a Table</option>
				<cfloop query="TableNames">	
					<cfif table_type IS "table">
						<option value="#tableNames.table_name#" <cfif tableNames.table_name IS tableName> selected="SELECTED" </cfif>>#tableNames.table_name#</option>
					</cfif>
				</cfloop>
