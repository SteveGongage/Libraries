...
<cfcomponent extends="cf.Gongage.utilities.LibraryBase">
	...
	<cfscript>
		...
		public function formatDateTime( required date dateIn, string delimiter = '@' ) {
			return dateFormat(arguments.dateIn, 'mm-dd-yyyy') & arguments.delimiter & lcase(timeFormat(arguments.dateIn, 'HH:mm t'));
		}
