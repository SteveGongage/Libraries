<!---
	...
	Usage:			Libraries are components that simply store functions
...
<cfcomponent>
	...
	---->
	<cffunction name="init" access="public" hint="Init method.  Takes the master utility library collection as an argument.">
