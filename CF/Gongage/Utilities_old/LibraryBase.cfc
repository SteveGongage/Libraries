...
<cfcomponent extends="UtilityBase">
	<!--- ================================================================================================ --->
	<!--- Properties --->
		...
		<cftry>
			...
			<cfcatch type="any">
				<cfif cfcatch.Message CONTAINS "Could not find the ColdFusion Component or interface">
					<cfset handleError('error,serious', 'OCMS', 'Utilities Library', '#arguments.libraryName# Creation Error', 'Error creating the library "#arguments.libraryName#" with component path "#arguments.componentPath#".  Error message is "#cfCatch.message#"', cfcatch)>
				<cfelse>
	...
	<cffunction name="help" access="public">
		<cfargument name="utilityName" required="true">
		<cfset var output = "">

		<cfif NOT structKeyExists(this, arguments.utilityName)>
			<cfset LOCAL.message = "Could not find a library with the name '#arguments.utilityName#">
		<cfelse>
